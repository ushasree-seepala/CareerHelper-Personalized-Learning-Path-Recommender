...
def recommend_path(goal):
    ...
    if goal == "data science":
        return [
            ("📺 Python Full Course (2025)", "https://www.youtube.com/watch?v=K5KVEU3aaeQ"),
        ...
        return [
            ("📺 Java Full Course", "https://www.youtube.com/watch?v=zBaFu3XEeTk"),
        ...
        return [
            ("📺 SSC CGL Maths (Akshay Sir)", "https://www.youtube.com/watch?v=sBOA3DjqslY"),
        ...
        return [
            ("📺 Bank Exam Quant Basics", "https://www.youtube.com/watch?v=nobGZzdkQNs"),
...
tk.Button(window, text="Show Learning Path", command=show_recommendations, font=("Arial", 12), bg="lightgreen").pack(pady=5)
